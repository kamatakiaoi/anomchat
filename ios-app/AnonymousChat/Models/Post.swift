...
public struct Comment: Codable, Identifiable {
    ...
    public init(id: Int, postId: Int, userId: String? = nil, uid: String? = nil, name: String = "Anon", avatar: String? = nil, color: String = "#3B82F6,#60A5FA", body: String = "", image: String? = nil, images: [String]? = nil, parentId: Int? = nil, replyName: String? = nil, replyText: String? = nil, time: String = "") {
        self.id = id
        self.postId = postId
        self.userId = userId
        self.uid = uid
