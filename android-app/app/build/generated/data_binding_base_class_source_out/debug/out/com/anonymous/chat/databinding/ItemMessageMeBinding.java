...
public final class ItemMessageMeBinding implements ViewBinding {
  ...
  public static ItemMessageMeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageMeBinding((LinearLayout) rootView, binding_audioPlayerView, btnReplyMsg,
          bubbleLayout, ivMsgAvatar, ivMsgVideoThumb, mediaContainer, msgVideoFrame, replyQuoteBox,
          tvMsgBody, tvMsgName, tvMsgTime, tvQuoteName, tvQuoteText);
    }
